...
The path to the module file is `dist/astring.js` and it can be included from an HTML webpage. When used in a browser environment, the module exposes a global variable `astring`:
